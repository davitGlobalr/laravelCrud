...
return [
    ...
    'login_password_confirmation'          => 'Подверждение пароля',
    'logout'                               => 'Выйте',
    'month'                                => 'Месяц',
    'no'                                   => 'Нет',
    ...
    'search'                               => 'Поиск',
    'searching'                            => 'Искать',
    'no_results'                           => 'Нет резултата',
    'results_could_not_be_loaded'          => 'Не удалось загрузить результаты',
    'search_input_too_short'               => 'Пожалуйста, введите: количество или больше символов',
    'show'                                 => 'Показать',
    ...
    'user_name'                            => 'Имя',
    'verifyYourEmail'                      => 'Пожалуйста, подтвердите вашу электронную почту',
    'verifyYourUser'                       => 'Чтобы завершить регистрацию - сайт просит подтвердить вашу электронную почту',
    'view'                                 => 'Вид',
    'view_file'                            => 'Посмотреть файл',
    'year'                                 => 'Год',
    'yes'                                  => 'Да',
    'youAreLoggedIn'                       => 'Вы вошли в систему!',
    'yourAccountNeedsAdminApproval'        => 'Для входа в ваши аккаунты требуется разрешение администратора.',
    'submit'                               => 'Подвердить',
    'datatables'                           => [
        'copy'          => 'Копя',
        'csv'           => 'CSV',
    ...
    'action'                               => 'Действие',
    'action_id'                            => 'id действие',
    'action_model'                         => 'Модел действие',
    'address'                              => 'Адресс',
